    ...
    <body>
        ...
        if (!$result2 || mysql_num_rows($result2) == 0) {
            ...
            if (strcmp($password, $cmdp) == 0) {
                switch ($type) {
                    case "eleve": 
                    $SQL1 = "INSERT INTO utilisateurs(eid,cid,sid,nom,prenom,email,login,mdp,valider,type) VALUES ('$id','0','0','$nomph','$prenomph','$email','$login','$password','0','$type')";
                    ...
                    if (!$result1) {
                        ...
                        if (!($result = mysql_query($SQL))) {
                            ...
                            $message_txt = 'Bonjour,' . $passage_ligne . $passage_ligne . $prenomph . ' ' . $nomph . ' E-mail: ' . $email . ' Login: ' . $login . ' ' . 'vient de cr&eacute;er un compte ' . $type . ' et attend une validation' . $passage_ligne . 'Mot de reconnaissance saisie : ' . $motdr . $passage_ligne . $passage_ligne . $passage_ligne . 'Merci';
                            ...
                            //=====Déclaration des messages au format texte et au format HTML.
                            $message_txt = 'F&eacute;licitations, vous venez de cr&eacute;er un compte sur le site de Demain le printemps.' . $passage_ligne . 'Votre login est: ' . $login . $passage_ligne . 'Tr&egrave;s bientot, le webmaster validera votre compte et vous recevrez un email de confirmation' .$passage_ligne . $passage_ligne . 'Cordialement' . $passage_ligne . 'L\'&eacute;quipe de Demain le Printemps';
                    ...
                    case "membre":
                    $SQL1 = "INSERT INTO utilisateurs(eid,cid,sid,nom,prenom,email,login,mdp,valider,type) VALUES ('0','$id','0','$nomph','$prenomph','$email','$login','$password','0','$type')";
                    $result1 = mysql_query($SQL1);
                    ...
                    if (!$result1) {
                        ...
                        if (!($result = mysql_query($SQL) || $result2 = mysql_query($SQL2))) {
                            ...
                            ini_set("sendmail_from", "demainleprintemps@gmail.com");
                            //=====Déclaration des messages au format texte et au format HTML.
                            $message_txt = 'Bonjour,' . $passage_ligne . $passage_ligne . $prenomph . ' ' . $nomph . ' vient de cr&eacute;er un compte et attend une validation' . $passage_ligne . 'Mot de reconnaissance saisie : ' . $motdr . $passage_ligne . $passage_ligne . 'Merci';
                    ...
                    $sql = "SELECT * FROM stagiaire where email='$email'" ;
                    $result = mysql_query($sql) ;
                    $table = mysql_fetch_assoc($result);
                    $sid = $table["sid"] ; 
                    
                    
                    $SQL1 = "INSERT INTO utilisateurs(eid,cid,sid,nom,prenom,email,login,mdp,valider,type) VALUES ('0','0','$sid','$nomph','$prenomph','$email','$login','$password','0','stagiaire')";
                    $result1 = mysql_query($SQL1);
                    ...
                    if (!$result1) {
                        ...
                        $SQL3 = "SELECT * FROM utilisateurs WHERE sid='$id'";
                        $result3 = mysql_query($SQL3);
                        $row = mysql_fetch_array($result3);
                        $uid = htmlspecialchars($row["uid"]);
...
// if everything is ok, try to upload file
                        ...
                        if (!$result1) {
                            ...
                            if (!($result = mysql_query($SQL))) {
                                ...
                                ini_set("sendmail_from", "demainleprintemps@gmail.com");
                                //=====Déclaration des messages au format texte et au format HTML.
                                $message_txt = 'Bonjour,' . $passage_ligne . $passage_ligne . $prenomph . ' ' . $nomph . ' vient de cr&eacute;er un compte ' . $type . '.' . $passage_ligne . 'Nom: ' . $nomph . $passage_ligne . 'Pr?nom: ' . $prenomph . $passage_ligne . 'Login: ' . $login . $passage_ligne . 'E-mail: ' . $email . $passage_ligne . $passage_ligne . 'Bonne r?ception' . $passage_ligne . 'Le webmaster';
                                ...
                                ini_set("sendmail_from", "demainleprintemps@gmail.com");
                                //=====Déclaration des messages au format texte et au format HTML.
                                $message_txt = 'F&eacute;licitations, vous venez de cr&eacute;er un compte sur le site de Demain le printemps.' . $passage_ligne . 'Votre login est: ' . $login . $passage_ligne . 'En attendant la cr&eacute;ation de l\'application android vous pouvez d&eacute;j&agrave vous connecter sur le site et g&eacute;rer votre profil en cliquant sur ce lien :' . $passage_ligne . '  http://www.ecole-theatrale.fr/connexion.php' . $passage_ligne . $passage_ligne . 'Cordialement' . $passage_ligne . 'L\'&eacute;quipe de Demain le Printemps';
//Tres bientot, le webmaster validera votre compte et vous recevrez un email de confirmation
                                //=====Création de la boundary
                                $boundary = "-----=" . md5(rand());
                                //==========
