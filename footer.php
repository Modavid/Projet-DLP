...
<section id="conteneur-footer">
	...
	<nav id="menu-footer">
		...
		<a href="contact.php" target="_blank"><div id="contact">
				...
				<aside id="pin-geolocalisation"><img src="/Image/images-design/pin-geolocalisation.png"alt="cottage"/></aside>
		...
		<a href="partenaires.php" target="_blank"><div id="partenaires">
			<div class="titre">Nos partenaires</div>
				<img src="/Image/images-design/bloc-logo.png" alt="partenaire" />
			</div>
		</a>
		<div id="ligne-mention-legale"><p>©2014 Demain le Printemps Association Loi 1901 | <a href="mentions-legales.php" target="_blank">Mentions légales</a> | <a href="developpeurs.php">Développeurs</a><!-- | <a href="benevoles.php">Bénévoles</a> --> </p></div>	
	</nav>
