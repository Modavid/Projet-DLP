			...
			if($dadde==1||$_SESSION['AUTH']==1)
				{
					...
					<div class="block-formulaire">
						...
						<form method="post" action="ajouter-membre.php" enctype="multipart/form-data" class="formulaire">
							<section>
							...
							<section>
								...
								<textarea name="details" cols="25" rows="7" maxlenght="460" required></textarea>
							</section><br>
