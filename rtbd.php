	...
	include(dirname(__FILE__)."/header.php");
        ...
        if (!$conn) {
            ...
            if (!$result || mysql_num_rows($result) == 0) {
                ...
                ?>
                    ...
                    for ($i = 0; $i < $lengthtotalphoto; $i++) {
                        if ($cpt == 0) {
                         ...
                         else if ($cpt == 3 && !empty($contenupage[$i]) && $i > 7 )
                         {
                             ?>
				...
				<ul type="center">
					<li><a class="fancybox" rel="group" href="/images-site/<?php echo $contenupage[3] ?>"><img src="/images-site/<?php echo $contenupage[3] ?>" width="300" height="300" alt="cottage"/></a></li>
                                        <li><a class="fancybox" rel="group" href="/images-site/<?php echo $contenupage[7] ?>"><img src="/images-site/<?php echo $contenupage[7] ?>" width="300" height="300" alt="cottage"/></a></li>
				</ul>
			...
			<div class="liens">
				<div class="fb-like" data-href="http://www.ecole-theatrale.fr/rtbd.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
