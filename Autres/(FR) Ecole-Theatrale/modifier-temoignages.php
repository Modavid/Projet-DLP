...
if(isset($_POST['titre']) && isset($_POST['commentaire']) && isset($_POST['tid']))
{
	...
	else
	{
		if ($_SESSION['AUTH'] != 1)
		{
			...
			$message_txt = 'Bonjour,'.$passage_ligne.$passage_ligne.$prenom.' '.$nom.' voudrait modifier un témoignage et attend sa validation, voici les détails :'.$passage_ligne;
			...
			//=====Définition du sujet.
			$sujet = '[Témoignage - modification] '.$nom.' '.$prenom;
			//=========
		...
		<br>
		<center>
			<img type="big" src="/images-site/remerciement.jpg" alt="Félicitation">
		</center>
		<br><br>
		<div align="center">
			Veuillez patienter que l'administrateur valide la modification de votre témiognage.<br>
