				...
				<tr>
					<td style="padding-left: 50px;padding-top: 50px">
						<img type="photo" src="uploaded/<?php echo $photo ;?>" alt="photo-demain-le-primtemps">
                                                <?php if($_SESSION['USERID']==$eid){ ?>
                                                <a href="form-profil-etudiant.php?eid=<?php echo $eid;?>&test=<?php echo $photo;?>">Modifier mon profil</a>
                                                <?php } ?>
					</td>
					<!-- nom  prenom-->
					<td style="padding-left: 50px;padding-top: 50px" width="300px">
						...
						<?php
							...
							while($row1=mysql_fetch_array($result1))
							{
								...
								echo 'FORMATION '.$i.': '.$type.' a '.$lieu.' en '.$mois.'-'.$annee;
								?><br><?php
								$i=$i+1;
							}
