...
<body>
 ...
 <section class="conteneur-superieur">
                ...
                ?>
                    ...
                    for ($i = 0; $i < $lengthtotalphoto; $i++) {
                        ...
                        } else if ($cpt == 3 && !empty($contenupage[$i])) 
                        {
                            ...
                            <img id="<?php echo $contents[$i] ?>" type="photo" style="max-width: 450px"  src="images-site/<?php echo $contenupage[$i] ?>"  />
                            <div>
                            <?php 
		...
		<div class="liens">
			<div class="fb-like" style="margin: auto" data-href="http://www.ecole-theatrale.fr/traduction.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
