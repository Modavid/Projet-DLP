...
<?php
	...
	<section class="conteneur-superieur">
		<div class="conteneur">
		<h1>Liste des fans</h1>
				
	<div id="conteneur-eleves">
	<?php

$SQL1="SELECT * FROM utilisateurs WHERE type='fan' ORDER BY uid DESC";
	...
	else
	{
		...
		?><table align="center"><?php
			...
			$SQL="SELECT * FROM utilisateurs WHERE type='fan'";
			$result=mysql_query($SQL);
				...
				while($row = mysql_fetch_array($result))
				{
					...
					?> 
						...
						<td type="eleve">
							<?php
								if(!$photo||!file_exists("uploaded/fans/" . $photo))
									$photo = "Pas-de-photo.jpg";
							?>
							<a href="afficher-profil-fc.php?uid=<?php echo $uid;?>">
								<img type="eleve" src="/uploaded/fans/<?php echo $photo;?>" alt="photo-demain-le-primtemps">
							</a>
							<br>
