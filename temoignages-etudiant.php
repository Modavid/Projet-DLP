...
<body>
	...
	<section class="conteneur-superieur">
		<div class="conteneur">
			<h1>Vos impressions du stage</h1>
			...
			<?php
				...
				while ($row = mysql_fetch_array ($result))
				{
					...
					<div id="conteneur-temoignage">
						...
						<h2>
						<a id="voirprofil" href="afficher-profil-eleve.php?eid=<?php echo $eid;?>">Voir profil</a>
						</h2>

						<?php
						$SQL3="SELECT * FROM etudiants WHERE eid='$eid'";
						...
						<h2 id="np">publié par <?php echo $nom." ".$prenom ?> </h2>
