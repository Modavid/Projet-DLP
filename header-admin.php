...
<section class="header-admin">
			...
			<li>
				...
				<ul>
					...
					<li> <a href="form-ajouter-actu.php">Ajouter une actu</a> </li>
				        <li> <a href="form-ajouter-partenaire.php">Ajouter un partenaire</a></li>
	...
	<?php
		...
		<section id="sous-header">
			 ...
			 <a href="form-profil-pedago.php?cid=<?php echo $cid;?>&test=<?php echo $photo;?>">Mon Profil</a> | <a href="deconnexion.php">Déconnexion</a>
		</section>
</section>
<!--Fin body-->
