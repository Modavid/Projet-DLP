                ...
                ?>
                    ...
                    for ($i = 0; $i < $lengthtotalphoto; $i++) {
                        ...
                        } else if ($cpt == 3 && !empty($contenupage[$i])) 
                        {
                            ...
                            {
                                ?>
                                <img id="<?php echo $contents[$i] ?>" type="photo"  src="images-site/<?php echo $contenupage[$i] ?>" style="margin-left: 15px"  />
                                <?php
                                }
                            else{ 
                            ?>
                    ...
                    ?>
                        ...
                        <div class="liens" >
			<div class="fb-like" style="margin: auto; padding-top: 0px"  data-href="http://www.ecole-theatrale.fr/emploi-du-temps.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
