...
<?php
		...
		if(!empty($_POST['uid']))
		{
			$uid = mysql_real_escape_string($_POST['uid']);
                        $SQ="SELECT * FROM utilisateurs WHERE uid='$uid' ";
			$resul=mysql_query($SQ);
			$ro=mysql_fetch_array($resul);
			
			$type2=htmlspecialchars($ro['type']);
			...
			if(isset($_FILES["myfile"]))
			{
				...
				else
				{
					...
					move_uploaded_file($temp,"uploaded/".$type2."s/".$name);
					
					$SQL13="SELECT * FROM utilsateurs WHERE uid='$uid'";
					$result13 = mysql_query($SQL13);
					$row13=mysql_fetch_array($result13);
					$anciennephoto=mysql_real_escape_string($row13['photo']);
					
					$SQL14="SELECT * FROM photo WHERE uid='$uid'";
					$result14=mysql_query($SQL14);
					$numrow14=mysql_num_rows($result14);
					$row14=mysql_fetch_array($SQL14);
					if($numrow14 ==0)
					{
					$SQL22="INSERT INTO photo(nomph,uid) VALUES ('$anciennephoto','$uid')";
					$result22 = mysql_query($SQL22);
					}
					$SQL10="UPDATE utilisateurs SET photo='$name' WHERE uid='$uid'";
					$result10 = mysql_query($SQL10);
					echo "--> Votre photo de profil est à jour.";?><br><?php
										
					$SQL="UPDATE profil SET photo='$name' WHERE uid='$uid'";
					$result = mysql_query($SQL);
					$SQL="UPDATE utilisateurs SET photo='$name' WHERE uid='$uid'";
					$result = mysql_query($SQL);
				}
			...
			if(isset($_FILES["myfile1"]))
			{
				...
				{
					move_uploaded_file($temp1,"uploaded/".$type2."s/".$name1);
					$SQL1="UPDATE profil SET photo1='$name1' WHERE uid='$uid'";
			...
			if(isset($_FILES["myfile2"]))
			{
				...
				{
					move_uploaded_file($temp2,"uploaded/".$type2."s/".$name2);
					$SQL2="UPDATE profil SET photo2='$name2' WHERE uid='$uid'";
				...
				if(isset($_POST['commp1']))
			{
				$commentphoto1 = mysql_real_escape_string($_POST['commp1']);
					...
					$SQL3="UPDATE profil SET commentphoto1='$commentphoto1' WHERE uid='$uid'";
			...
			if(isset($_POST['commp2']))
			{
				$commentphoto2 = mysql_real_escape_string($_POST['commp2']);
					...
					$SQL3="UPDATE profil SET commentphoto2='$commentphoto2' WHERE uid='$uid'";
					$result3 = mysql_query($SQL3);
			...
			if(isset($_POST['descriptif']))
			{
				$descriptif = mysql_real_escape_string($_POST['descriptif']);
					...
					$SQL3="UPDATE profil SET descriptif='$descriptif' WHERE uid='$uid'";
					$result3 = mysql_query($SQL3);
			...
			if(isset($_POST['commentaire']))
			{
				$commentaire = mysql_real_escape_string($_POST['commentaire']);
					...
					$SQL4="UPDATE profil SET commentaire='$commentaire' WHERE uid='$uid'";
				...
				if(isset($_POST['commentaire2']))
			{
				$commentaire2 = mysql_real_escape_string($_POST['commentaire2']);
					...
					$SQL4="UPDATE profil SET comment2='$commentaire2' WHERE uid='$uid'";
					$result4 = mysql_query($SQL4);
			...
			if(isset($_POST['video1']))
			{
				$video1 = mysql_real_escape_string($_POST['video1']);
					...
					$SQL5="UPDATE profil SET video1='$video1' WHERE uid='$uid'";
			...
			if(isset($_POST['video2']))
			{
				$video2 = mysql_real_escape_string($_POST['video2']);	
					...
					$SQL6="UPDATE profil SET video2='$video2' WHERE uid='$uid'";
			...
			if(isset($_POST['site']))
			{
				...
				$SQL="UPDATE profil SET site='$site' WHERE uid='$uid'";
			...
			?>
				...
				<br>
				<center>
					<a href="index.php">Retourner à l'accueil</a> <br>ou<br> <a href="afficher-profil-fc.php?uid=<?php echo $uid;?>">Voir profil</a>
				</center>
				</h2>
			<?php
		}//fin if(eid)
